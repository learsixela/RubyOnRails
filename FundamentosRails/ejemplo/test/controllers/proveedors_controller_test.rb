...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { apellido: @proveedor.apellido, contrasena: @proveedor.contrasena, edad: @proveedor.edad, email: @proveedor.email, nombre: @proveedor.nombre } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { apellido: @proveedor.apellido, contrasena: @proveedor.contrasena, edad: @proveedor.edad, email: @proveedor.email, nombre: @proveedor.nombre } }
